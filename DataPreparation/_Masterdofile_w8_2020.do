...
global latestyear 2020	// set up to which year the database goes
...
merge m:1 SBFINr using "$path_gd/Berufe/sbfi_all.dta",  keep(master match) keepusing(anf_mean anf_math anf_langschool anf_nat anf_langfor spec Lehrdauer Anzahl_Lektionen) nogen
drop SBFINr

sort pid year 
	
save "$output/SEATS2020.dta", replace	
